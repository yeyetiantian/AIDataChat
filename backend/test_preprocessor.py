...
TEST_CASES = [
    ...
    "生成折线图，Y轴信号[EngActStdyStTorq、MtrBTorqAchvd、HiVltgBatMinCellVltg、OtsAirTmpCrVal、MtrATorqAchvd、HiVltgBatAvgTemp]，X轴报警时间计数，不指定图例，关联任务：ND EREV 工程车基本工作信息_5377_1，数据筛选时间从2025-08-29 00:00:00 到 2025-09-04 23:59:59"
]
